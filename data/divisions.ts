    ...
    products: [
      {
        ...
        description: "First-line SSRI for major depression and generalised anxiety disorder",
      ...
      },
      {
        ...
        description: "SSRI for OCD, panic disorder, PTSD and social anxiety",
      ...
      },
      {
        ...
        description: "SSRI for depression, bulimia nervosa and OCD",
        composition: "Fluoxetine HCl IP 20 mg",
        category: "Antidepressant",
      },
      {
        id: "n4",
        name: "Duloxetine 30 mg",
        description: "SNRI for major depression, GAD and diabetic neuropathy",
        composition: "Duloxetine HCl IP 30 mg",
        category: "Antidepressant",
      },
      {
        id: "n5",
        name: "Venlafaxine 75 mg",
        description: "SNRI for depression, anxiety and panic disorder",
        composition: "Venlafaxine HCl IP 75 mg",
        category: "Antidepressant",
      },
      {
        id: "n6",
      ...
      },
      {
        ...
        description: "Benzodiazepine for seizure management and panic disorder",
      ...
      },
      {
        ...
        description: "Short-term anxiolytic for generalised anxiety and panic attacks",
      ...
      },
      {
        id: "n9",
        name: "Lorazepam 1 mg",
        description: "Fast-acting benzodiazepine for acute anxiety and pre-op sedation",
        composition: "Lorazepam IP 1 mg",
        category: "Anxiolytic",
      },
      {
        id: "n10",
        name: "Pregabalin 75 mg",
        description: "Alpha-2-delta ligand for neuropathic pain and partial seizures",
      ...
      },
      {
        ...
        description: "GABA analogue for partial seizures and postherpetic neuralgia",
        composition: "Gabapentin IP 300 mg",
        category: "Neuropathic",
      },
      {
        id: "n12",
        name: "Topiramate 25 mg",
        description: "Antiepileptic for partial seizures and migraine prophylaxis",
        composition: "Topiramate IP 25 mg",
        category: "Antiepileptic",
      },
      {
        id: "n13",
        name: "Lamotrigine 25 mg",
        description: "Sodium channel blocker for epilepsy and bipolar disorder",
        composition: "Lamotrigine IP 25 mg",
        category: "Antiepileptic",
      },
      {
        id: "n14",
        ...
        composition: "Quetiapine Fumarate IP 25 mg",
        category: "Antipsychotic",
      },
      {
        id: "n15",
        name: "Olanzapine 5 mg",
        description: "Atypical antipsychotic for schizophrenia and acute mania",
        composition: "Olanzapine IP 5 mg",
        category: "Antipsychotic",
      },
      {
        id: "n16",
        name: "Zolpidem 5 mg",
        description: "Non-benzodiazepine hypnotic for short-term insomnia",
        composition: "Zolpidem Tartrate IP 5 mg",
        category: "Sleep",
      },
    ],
  },
